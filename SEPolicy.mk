...
#ifneq (,$(filter sdm660 msm8937 msm8953 msm8996 msm8998 msm8994, $(TARGET_BOARD_PLATFORM)))
...
ifneq (,$(filter userdebug eng, $(TARGET_BUILD_VARIANT)))
BOARD_SEPOLICY_DIRS += \
	$(SEPOLICY_PATH)/legacy/vendor/test
...
BOARD_SEPOLICY_DIRS += \
    ...
    $(SEPOLICY_PATH)/legacy/vendor/ssg \
    $(SEPOLICY_PATH)/legacy/vendor/common \
    $(SEPOLICY_PATH)/legacy/vendor/$(TARGET_BOARD_PLATFORM)
